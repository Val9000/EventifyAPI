...
import services.JaxRsApiApplication;
...
public class AppConfig {
	...
	public Server jaxRsServer() {
            ...
            factory.setServiceBeans( Arrays.< Object >asList( eventService(), loginService(), registerService(), userService(), apiListingResourceJson() ) );
	...
	public BeanConfig swaggerConfig( Environment environment ) {
            ...
            config.setScan( true );
            config.setResourcePackage( Event.class.getPackage().getName() );
            config.setBasePath( 
